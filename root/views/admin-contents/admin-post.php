...
<html lang="en">
        ...
        <script>
            $(function() {
                    ...
                    if (input.files) {
                        ...
                        for (i = 0; i < filesAmount; i++) {
                            ...
                            reader.onload = function(event) {
                                $($.parseHTML('<img>')).attr('src', event.target.result).wrap('<li class="imgs"></li>').parent().appendTo(placeToInsertImagePreview);
                            }
                ...
                $('#input-files').on('change', function() {
                    imagesPreview(this, 'div.displayImg ul');
                });
            });
        </script>
        
        <!--pam: input file button stylings-->
        <script>
	...
	<body >
        ...
        <section id="post">
            ...
            <!--pam: shows multiple photos users adding-->
            <div id="display-images" class="displayImg">
                <ul></ul>
            </div>
<!--
william - db
...
-->
                    ...
                    <li>
                        ...
                        <textarea name="description"
                                  rows="5"
                                  cols="49" 
                                  placeholder="What a great trip to Norway..." 
                                  required></textarea>
                    </li>
                    <li id="rating">
                        <div class="stars">
                    ...
                    <li>
                  <form method="post" action="<?php $_SERVER['PHP_SELF']?>?action=imageUpload"                                                                             enctype="multipart/form-data">
                        <div class="input-file-container inline">
